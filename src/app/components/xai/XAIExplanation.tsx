...
import { Brain, Lightbulb, Eye } from "lucide-react";
import { ExplanationData } from "@core/types/xai.types";
import { XAIConceptBadges } from "./XAIConceptBadges";

interface XAIExplanationProps {
  analysis: ExplanationData;
}
